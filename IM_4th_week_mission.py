...
character1_name = 'abc'
character1_attack = 100
character1_health = 100
character1_speed = 100
print(f"{character1_name}님 소환사의 협곡에 오신 것을 환영합니다.")

character_info(character1_name, character1_attack, character1_health, character1_speed)# <character_info()를 호출하여 character1의 정보 출력하기 >

# character2 만들어주기(정보 할당)
character2_name = 'abcd'
character2_attack = 200
character2_health = 200
character2_speed = 200
...
character3_name = 'abcde'
character3_attack = 300
character3_health = 300
character3_speed = 300
...
class Character: # Character class 정의해주기
    ...
    def charater_info(self):# character_info() 메서드 정의
...
character1 = Character('aaa', 200, 300, 5)
character1.charater_info()


character1 = Character('bbb', 100, 100, 4)
character1.charater_info()


character1 = Character('ccc', 300, 200, 3)
character1.charater_info()
