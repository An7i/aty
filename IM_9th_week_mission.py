...
t.onkeypress(left, "Left") # up 함수 이벤트 처리(onpress)
t.onkeypress(right, "Right") # down 함수 이벤트 처리(onpress)
t.onkeypress(close_window, "Escape") # down 함수 이벤트 처리(onpress)
